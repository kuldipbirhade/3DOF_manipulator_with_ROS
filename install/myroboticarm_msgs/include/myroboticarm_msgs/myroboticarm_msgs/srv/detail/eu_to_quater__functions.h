...
// IWYU pragma: private, include "myroboticarm_msgs/srv/eu_to_quater.h"


#ifndef MYROBOTICARM_MSGS__SRV__DETAIL__EU_TO_QUATER__FUNCTIONS_H_
#define MYROBOTICARM_MSGS__SRV__DETAIL__EU_TO_QUATER__FUNCTIONS_H_
...
/// Initialize srv/EuToQuater message.
/**
 ...
 * )) before or use
 * myroboticarm_msgs__srv__EuToQuater_Request__create()
...
/// Finalize srv/EuToQuater message.
/**
...
/// Create srv/EuToQuater message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * myroboticarm_msgs__srv__EuToQuater_Request__init().
...
/// Destroy srv/EuToQuater message.
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Request__fini()
...
/// Check for srv/EuToQuater message equality.
/**
...
/// Initialize array of srv/EuToQuater messages.
/**
...
/// Finalize array of srv/EuToQuater messages.
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Request__fini()
...
/// Create array of srv/EuToQuater messages.
/**
...
/// Destroy array of srv/EuToQuater messages.
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/EuToQuater message array equality.
/**
...
/// Copy an array of srv/EuToQuater messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * myroboticarm_msgs__srv__EuToQuater_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * myroboticarm_msgs__srv__EuToQuater_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
...
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
...
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * myroboticarm_msgs__srv__EuToQuater_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * myroboticarm_msgs__srv__EuToQuater_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
...
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
...
/**
 * It allocates the memory for the array and calls
 * myroboticarm_msgs__srv__EuToQuater_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_myroboticarm_msgs
...
/**
 * It calls
 * myroboticarm_msgs__srv__EuToQuater_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYROBOTICARM_MSGS__SRV__DETAIL__EU_TO_QUATER__FUNCTIONS_H_
