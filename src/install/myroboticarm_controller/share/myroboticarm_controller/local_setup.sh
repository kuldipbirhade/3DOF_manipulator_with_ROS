...
: ${AMENT_CURRENT_PREFIX:="/home/kuldip/myroboticarm_ws/src/install/myroboticarm_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/myroboticarm_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/myroboticarm_controller/environment/path.sh"
